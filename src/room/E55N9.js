...
var E55N9 = {  
    run: function(roomName) {  
        var sourceRooms = ['E55N9','E54N9','E55N8','E49N9','E53N1','E53N2','E52N1']; 
        var targetRooms = ['E55N9','E54N9','E55N8','E49N9','E53N1','E53N2','E52N1'];  
        ...
        if (firstSpawn.room.energyAvailable < 10000 && !tasksList.some(task => task.type === 'fillExtension')) {  
            // 推送 'fillExtension' 任务  
        ...
        var mainRoomRoleConfigs = [     //主房间运维组
            ...
            //{ role: 'adventurer',       sourceRoom: sourceRooms[5], targetRoom: targetRooms[0], workLoc: [0],     maxNumber: 0, priority: 5},  
            { role: 'claimer',          sourceRoom: sourceRooms[2], targetRoom: targetRooms[0], workLoc: [0],     maxNumber: 0, priority: 5},    
            { role: 'Centraltransferer',sourceRoom: sourceRooms[0], targetRoom: targetRooms[0], workLoc: [0],     maxNumber: 1, priority: 4},
            { role: 'scavenger',        sourceRoom: sourceRooms[3], targetRoom: targetRooms[3], workLoc: [0],     maxNumber: 0, priority: 9},
            { role: 'thinker',          sourceRoom: sourceRooms[0], targetRoom: targetRooms[0], workLoc: [3],     maxNumber: 1, priority: 9},
            { role: 'defenser',         sourceRoom: sourceRooms[0], targetRoom: targetRooms[0], workLoc: [0],     maxNumber: 0, priority: 9},
            { role: 'repairer',         sourceRoom: sourceRooms[0], targetRoom: targetRooms[0], workLoc: [0],     maxNumber: 0, priority: 9},
            ...
            { role: 'Newbuilder',       sourceRoom: sourceRooms[4], targetRoom: targetRooms[4], workLoc: [1,0],   maxNumber: 0, priority: 5},
            { role: 'Newbuilder',       sourceRoom: sourceRooms[5], targetRoom: targetRooms[4], workLoc: [1,0],   maxNumber: 0, priority: 1},  
            { role: 'Newbuilder',       sourceRoom: sourceRooms[6], targetRoom: targetRooms[4], workLoc: [1,0],   maxNumber: 0, priority: 1},  
        ...
        var remoteMiningRoleConfigs = [  //外矿运维组
            ...
            { role: 'claimer',          sourceRoom: sourceRooms[2], targetRoom: targetRooms[0], workLoc: [0],     maxNumber:  0, priority: 5}, 
            { role: 'repairer',         sourceRoom: sourceRooms[2], targetRoom: targetRooms[0], workLoc: [0],     maxNumber:  0, priority: 6},
        ...
        if( flag ){
            for (let spawn of spawns) { //遍历所有spawn 
                if (checkCreepLimit('scavenger', sourceRooms[3], targetRooms[3], 0, 3)) {
                    spawnCreep(spawn, 'scavenger', sourceRooms[3], targetRooms[3], 0, createCreepBody('scavenger'));
                }
            }
        }
        ...
        for (let spawn of spawns) { //遍历所有spawn                     
            for (let config of mainRoomRoleConfigs) { //每个spawn遍历运维组
                ...
                if (isSpawning(spawn)) { // 如果当前孵化器正在生产，则跳过剩余的配置secondSpawn
                    break;
                }
            }
        }
...
function createCreepBody(role) {    //返回body
    ...
    switch (role) {  
        ...
        case 'builder':  
            ...
            break;  
        case 'adventurer':  
            body = [MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY];  
            break; 
        case 'Newtransferer':  
            ...
            break;  
        case 'scavenger':  
            body = [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE]; 
            break;
        ...
        case 'Newbuilder':  
            ...
            break;  
        case 'repairer':  
            body = [MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,HEAL,HEAL,HEAL,HEAL,CLAIM];  
            break;  
        case 'thinker':  
            body = [MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY];  
            break;  
        case 'Demolisher':  
            body = [WORK,WORK,WORK,WORK,WORK,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,MOVE]; 
            break; 
        case 'Healer':  
            body = [TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,MOVE]; 
            break;  
        default:  
            body = [MOVE];  
    }  
