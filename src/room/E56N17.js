...
var E56N17 = {  
    run: function(roomName) { 
        var sourceRooms = ['E56N17']; 
        var targetRooms = ['E56N17'];
        ...
        if (firstSpawn.room.energyAvailable < 6500 && !tasksList.some(task => task.type === 'fillExtension')) {  
            // 推送 'fillExtension' 任务  
        ...
        // console.log(firstSpawn.room.controller.ticksToDowngrade)
        if(tasksList.some(task => task.type === 'spawn')){
            if (checkCreepLimit('defenser', sourceRooms[0], targetRooms[0], 0, 1)) {
                spawnCreep(spawns[1], 'defenser', sourceRooms[0], targetRooms[0], 0, createCreepBody('defenser'));
            }
        } 
...
function createCreepBody(role) {    //返回body
    ...
    switch (role) {  
        ...
        case 'transferer':  
            ...
            break;  
        case 'claimer':  
            body = [TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL];  
            break;  
        case 'manager':  
        ...
        case 'upgrader':  
            ...
            break;  
        case 'builder':  
            body = [MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY];  
            break;  
        case 'repairer':  
        ...
        case 'defenser':
            ...
            break;
        case 'scavenger':  
            body = [MOVE,MOVE,MOVE,MOVE,MOVE,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY];  
            break;  
        case 'Newbuilder':  
