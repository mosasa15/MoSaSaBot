import InsectNameManager from '../utils/creepNameManager'; // 导入InsectNameManager

var E58N14 = {  
    run: function( roomName ) {  
        
        var sourceRooms = ['E58N14','E58N15']; 
        var targetRooms = ['E58N14','E58N15']; 
        ...
        var mainRoomRoleConfigs = [     //主房间运维组
            ...
            { role: 'adventurer',       sourceRoom: sourceRooms[0], targetRoom: targetRooms[1], workLoc: [1,0],     maxNumber: 0, priority: 5},   
            { role: 'claimer',          sourceRoom: sourceRooms[5], targetRoom: targetRooms[0], workLoc: [1],     maxNumber: 0, priority: 5},    
            { role: 'thinker',          sourceRoom: sourceRooms[0], targetRoom: targetRooms[0], workLoc: [3],     maxNumber: 0, priority: 9},

            { role: 'Newbuilder',       sourceRoom: sourceRooms[0], targetRoom: targetRooms[1], workLoc: [1,0],   maxNumber: 0, priority: 6}, 
        ...
        //     // console.log('有矿快挖 ')
        // } 
        if(tasksList.some(task => task.type === 'spawn_1')){
            if (checkCreepLimit('Newbuilder', sourceRooms[1], targetRooms[1], 0, 1)) {
                spawnCreep(spawns[2], 'Newbuilder', sourceRooms[1], targetRooms[1], 0, createCreepBody('Newbuilder'));
            }
            if (checkCreepLimit('Newbuilder', sourceRooms[1], targetRooms[1], 1, 1)) {
                spawnCreep(spawns[1], 'Newbuilder', sourceRooms[1], targetRooms[1], 1, createCreepBody('Newbuilder'));
            }
        } 
...
function createCreepBody(role) {    //返回body
    ...
    switch (role) {  
        ...
        case 'NewHarvester':  
            ...
            break;  
        case 'Newbuilder':  
            body = [MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY];  
            break;  
        case 'scavenger':  
            body = [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE];  
            break;  
        case 'repairer':  
